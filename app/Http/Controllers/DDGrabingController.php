...
class DDGrabingController extends Controller
{
    ...
    public function index()
    {
        ...
        ))->matchAll(array('price' => '/title="EUR">(.*?)</ms',))->URLs('https://www.norwegian.com/en/booking/flight-tickets/select-flight/?A_City=RIX&AdultCount=1&ChildCount=0&CurrencyCode=EUR&D_City=OSL&D_Day=01&D_Month=201710&IncludeTransit=false&InfantCount=0&R_Day=29&R_Month=201708&TripType=1');
        $info = $cc->get();
        $info['info'] = $info;
