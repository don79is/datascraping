...
class SASController extends Controller
{
    ...
    public function index()
    {
        ...
        $file->matchALL(array(
            'day' => '!<span class="date">(.*?)<\/span>!',
            'price' => '!<span class="price"><input type="hidden" id="recoHidden_0_0_PREMB" value="5"> <span class="currency">€<\/span><span class="number tobeupdated1" id="price_0_0_PREMB" data-price="">(.*?)<\/span> <\/span>',
